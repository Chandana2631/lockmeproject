...
public class App 
{
	...
	public static void fileList() throws IOException {
		...
		// creates a file object
        File file = new File("/home/18491a0432qisce/Desktop/ALockmeFirstProject/LockedMeApplication/src/main/java/com/simplilearn/lockme/cmdlineapplication/LockedMeApplication/Locker");
